...
const Footer = () => {
  ...
  return (
    <footer className="my-[15rem] bg-[#E4E3E3]">
      <div className="relative mx-[20px] h-[10rem] md:mx-[32px] lg:mx-[160px] 2xl:mx-[320px]">
      ...
      <div className="grid gap-[54px] px-[20px] py-10 md:gap-[32px] md:px-[32px] lg:grid-cols-[2fr_3fr] xl:grid-cols-[1.5fr_4fr] xl:gap-0 xl:px-[160px] 2xl:px-[320px]">
